...
#define CMD_SCAN_KEY_ENABLE	    	_IO(0xFF,4)
#define CMD_SCAN_KEY_DISABLE	    	_IO(0xFF,5)
#define CMD_READ_END	    		_IO(0xFF,6)
...
#ifndef bCheckPermission
#define  bCheckPermission  1
#endif
...
#define SYS_GETCHARGINGSTATUS   0x29
#define SYS_GETBATTARYSTATUS   0x2B
...
#define EXTERNAL_SERIAL_OPEN_EX 0x08

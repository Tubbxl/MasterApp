...
//scan module API
#define  Scan_Open_Ok			0
#define  Scan_Open_Err			-6000
#define  Scan_PowerOn_Err			-6001
#define  Scan_PowerOff_Err			-6002
#define  Scan_Stop_Err			-6003
#define  Scan_Read_Err			-6004
#define  Scan_Read_Ok			0
#define  Scan_Close_Ok			0
#define  Scan_Trigger_Err			-6005
#define  Scan_Trigger_Ok			0
#define  Scan_Not_Open			-6006
...
#define	WLANKEYERR		-9500
#define	WLANNOUER			-9501
#define	WLANTIMEOUT		-9502
#define	WLANDHCPERR		-9503
#define	WLANAUTHENTICATING		-9504
